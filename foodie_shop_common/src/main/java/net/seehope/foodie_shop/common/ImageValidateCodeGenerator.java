...
import net.seehope.foodie_shop.validate.DefaultImageValidateCodeGenerator;
...
public class ImageValidateCodeGenerator {
    ...
    public ImageValidateCode generatorValidateCode(int width,int height) {
        ...
        g.dispose();
        // 创建
        return new ImageValidateCode(sRand.toString(), 60*15, image);
    }
